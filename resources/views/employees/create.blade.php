            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="float: left"><strong>Tous les Employés</strong> </h2>
                            <button class="btn btn-sm btn-primary" style="float: right" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop">Nouveau Employé</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"><strong>Nouveau Employé</strong> </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                    {{-- <h1 class="text-center">Inscription des Employés</h1> --}}
                    <div class="container">
                        <div class="row">
                            <div class="">
                                <form action="{{ route('employees.store') }}" method="post" class="m-5">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="profil" class="form-select" id="role">
                                            <option value=""></option>
